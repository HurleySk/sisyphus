...
- **Engine built and tested** -- 245 tests, CLI working (`npx sisyphus run/validate`)
...
- Abort support: `q` key kills in-flight subprocesses via AbortController signal threading
